...
def run_master(master_redis_cfg, log_dir, exp):
    ...
    #BJ - added limiter to stop the master thread after a certain number of iterations
    num_steps = 600
    for r in range(num_steps):
        ...
        #BJ - modified for constant snapshots
        if config.snapshot_freq != 0:
            import os.path as osp
            filename = 'shots/snapshot_iter{:05d}_rew{}.h5'.format(
                #BJ - added a folder for snapshots for efficiency
                curr_task_id,
